...
import { PomodoroDto } from './dto/pomodoroDto.dto'
import { PomodoroSessionDto } from './dto/pomodoroSessionDto.dto'
...
export class PomodoroController {
	...
	@Put('/round/:id')
	@Auth()
	async updateRound(@Param('id') id: string, @Body() dto: PomodoroDto) {
